  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">               
                <p>From: <b><?=$date_from?></b></p>
                <p>To: <b><?=$date_to?></b></p>
                <p>Price: <b><?=$price?>&euro;</b></p>          
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                ...
                <div class="row mt-3">
                    <div class="col-12">               
                        <p>Firs name: <b><?=$first_name?></b></p>
                        <p>Last name: <b><?=$last_name?></b></p>
                        <p>Country: <b><?=$country_name?></b></p>          
                        <p>Passport number: <b><?=$passport_number?></b></p>          
                    </div>
                </div>
            </div>
            <div class="col-6">
            <div class="row mt-3">
                ...
                <div class="row mt-3">
                    <div class="col-12">               
                        <p>Manufacturer: <b><?=$manufacturer_name?></b></p>
                        <p>Model: <b><?=$model_name?></b></p>
                        <p>Registration number: <b><?=$registration_number?></b></p>          
                        <p>Year: <b><?=$year?></b></p>          
