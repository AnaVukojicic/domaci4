<?php
    ...
    $country_id_model=$client['country_id'];
        ...
        <form action="./update_client.php" method="post">
          ...
          <div class="row">
                ...
                <select name="country" class="form-control" id="country">
                    <?php
                        ...
                        while($row=mysqli_fetch_assoc($countries)){
                            ...
                            $selected="";
                            if($country_id==$country_id_model){
                                $selected="selected";
                            }
            ...
            <div class="col-6">
                ...
                <input type="text" id="passport_number" name="passport_number" class="form-control" value="<?=$passport_number?>">
            </div>
          </div>
          <div class="row mt-3">
          <div class="col-6">
