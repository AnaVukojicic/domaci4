...
<head>
  ...
  <title>Car rental | Classes</title>
      ...
      <div class="container-fluid">
        <div class="row">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row=mysqli_fetch_assoc($classes)){
                                        ...
                                        echo "<tr>
                                                <td>$class_name</td>    
                                                <td><a href=\"./classes/edit_class.php?class_id=".$class_id."\" class=\"btn btn-outline-warning\">Edit</a></td>    
                                                <td><button class=\"btn btn-outline-danger\" data-toggle=\"modal\" onclick=\"fillModal('".$class_name."',".$class_id.")\" data-target=\"#deleteClass\">Delete</button></td>    
                                            </tr>";
                                    }
            ...
            <div class="col-6 offset-1">
                ...
                <form action="./classes/save_class.php" method="post">
                    <div class="row">
                        <div class="col-12">
...
<script>
  function fillModal(name,id){
    ...
    document.getElementById('modalButtons').innerHTML=`<button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                            <a href="./classes/delete_class.php?class_id=${id}" type="button" class="btn btn-primary">YES</a>`
  }
</script>
